...
/* 13 */
/*!***********************************************************************!*\
  !*** E:/1MyProject/smi_dome/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \***********************************************************************/
...
/* 14 */
/*!****************************************************!*\
  !*** E:/1MyProject/smi_dome/pages/index/index.vue ***!
  \****************************************************/
/*! no static exports found */
...
/* 15 */
/*!***********************************************************************************!*\
  !*** E:/1MyProject/smi_dome/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \***********************************************************************************/
...
/* 16 */
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/1MyProject/smi_dome/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 17 */
/*!*****************************************************************************!*\
  !*** E:/1MyProject/smi_dome/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 18 */
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/1MyProject/smi_dome/pages/index/index.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  (0, _vuex.mapState)({
    isFlag: function isFlag(state) {return state.isFlag;},
    socketMessage: function socketMessage(state) {
  ...
  onShareAppMessage: function onShareAppMessage(res) {
    ...
    return {
      title: '分享一下',
      path: "/pages/index/index?userId=".concat(this.identity.userId, "&obj=").concat(obj) };
  ...
  methods: {
    bindGetUserInfo: function bindGetUserInfo(e) {var _this2 = this;
      ...
      uni.getUserProfile({ // 登录授权
        ...
        success: function success(res) {
          console.log(res);
          _this2.userInfo = res.userInfo; // 获取用户信息 
          _this2.$store.dispatch('SET_USER_INFO', res.userInfo); // 调用vuex存储
          uni.login({ // 获取code
            success: function success(r) {
              ...
              uni.request({
                url: "http://192.168.0.64:8888/bluetoothApplets/user/login?code=".concat(r.code),
                        ...
                        if (y.data.code == 200) {
                          ...
                          if (_this.isFlag) {
                            ...
                            var param = {
                              ...
                              'message': "\u54C8\u54C8\u54C8\u54C8".concat(new Date()) // 信息
                            };
    ...
    onGetuuid: function onGetuuid() {
      ...
      if (that.isConnected) {// 连接成功
        ...
        uni.getBLEDeviceServices({
          deviceId: that.deviceId,
          success: function success(getServicesRes) {
            ...
            uni.getBLEDeviceCharacteristics({
              deviceId: that.deviceId,
              serviceId: that.serviceId,
              success: function success(getCharactersRes) {
                ...
                uni.notifyBLECharacteristicValueChange({
                  ...
                  success: function success() {
                    ...
                    uni.onBLECharacteristicValueChange(function (onNotityChangeRes) {
                      ...
                      var characteristicValue = that.ab2hex(onNotityChangeRes.value);
                      console.log("characteristicValue-16进制", characteristicValue);
                      // 设备给你返回的
                      uni.showModal({
                        title: '监听到特征值更新',
                        content: "\u66F4\u65B0\u540E\u7279\u5F81\u503C".concat(characteristicValue) });
    ...
    // 关闭连接
    onCloseConnect: function onCloseConnect() {
...
/* 19 */
/*!*************************************************************************************!*\
  !*** E:/1MyProject/smi_dome/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 20 */
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/1MyProject/smi_dome/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
